...
def plot_offset_fishbowl():
    dire = ['single_variable/fishbowl/x_offset','single_variable/fishbowl/x_offset_full_aperture','single_variable/fishbowl/y_offset','single_variable/fishbowl/y_offset_full_aperture']
    fig = plt.figure()
    ax = fig.add_subplot(111)
    for dir in dire:
        lst = os.listdir(dir)
        ...
        elif dir == 'single_variable/fishbowl/x_offset':
            ax.plot(sort[:,0],sort[:,1],c='b')
            # ax.plot(sort[:,0],sort[:,1],c='b')
